...
def bilinear_wrapper(imgs, coords):
    ...
    coords_height = coords_shape[1]
    coords_width = coords_shape[2]
    imgs_sampled = tf.image.resize(
        imgs, [coords_height, coords_width], method=tf.image.ResizeMethod.BILINEAR)
